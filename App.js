...
function Tabs ({navigation}) {
    ...
    <Tab.Navigator tabBarOptions={{showLabel :false}} screenOptions={{ headerShown: false,showLabel :false }}>
        <Tab.Screen name="Accueil" component={Home} options={{tabBarIcon :({focused}) => (
        ...
        <Tab.Screen name="RechercheMap" component={RechercheMap} options={{ tabBarIcon :({focused}) => (
            <View style={{alignItems :'center',justifyContent:'center',top : 14}}>
        ...
        <Tab.Screen name="AddAnnonce" component={AddAnnonce} options={{ tabBarIcon :({focused}) => (
            <View style={{alignItems :'center',justifyContent:'center',top : 14}}>
        ...
        <Tab.Screen name="Mes Plantes" component={MesPlantes} options={{ tabBarIcon :({focused}) => (
            <View style={{alignItems :'center',justifyContent:'center',top : 14}}>
        ...
        <Tab.Screen name="Profil" component={Profil} options={{ tabBarIcon :({focused}) => (
            <View style={{alignItems :'center',justifyContent:'center',top : 14}}>
